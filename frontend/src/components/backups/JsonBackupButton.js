...
const JsonBackupButton = () => {
  ...
  const handleBackup = async () => {
    try {
      ...
      const response = await axios.get('/api/backup/json/backup', {
        responseType: 'blob',
        headers: {
  ...
  return (
    ...
    >
      {isLoading ? 'Creating Backup...' : 'Download Company Backup In Json'}
    </button>
  );
};
...
export default JsonBackupButton;